...
def loadModelForecast(path, panel):
    ...
    forecast["allocationTier"] = "Routine baseline coverage"
    forecast.loc[forecast["predictedCrimeCount"] >= q75, "allocationTier"] = "Reserve / spike watch"
    forecast.loc[forecast["predictedCrimeCount"] >= q90, "allocationTier"] = "Priority patrol and problem-solving"
